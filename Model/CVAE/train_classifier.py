...
regression_model = create_model(len(temps))
regression_model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])
...
# Add the early stopping callback to the fit function
history = regression_model.fit(trainset, epochs=50, validation_data=testset, callbacks=[early_stopping])
